...
namespace _02_Veriables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("***** Fiiyat Listesi *****");
            Console.WriteLine();
            ...
            //Console.WriteLine("---------------------------");
            //Console.WriteLine("Yolcu TC Kimlik No : " + passengerIDNumber + " - Yolcu Adı Soyadı : " + passengerName + " " + passengerSurname + " " + passengerDistrict + " / " + passengerCity + " " + passengerAge);
